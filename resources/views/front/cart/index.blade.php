...
@section('content')
    ...
    <h2 class="mt-5"><i class="fa fa-shopping-cart"></i> Panier</h2>
    <hr>

    @if ( Cart::instance('default')->count() > 0 )

        <h4 class="mt-5">{{ Cart::instance('default')->count() }} article(s) dans le panier</h4>
        ...
        <div class="cart-items">
            ...
            <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('cart.saveLater', $item->rowId) }}" method="post">
                                        ...
                                        <button type="submit" class="btn btn-link btn-link-dark">Mettre en attente</button>
                ...
                <!-- Save for later  -->
                <div class="col-md-12">
                    <a href="/" class="btn btn-outline-dark">Continuer</a>
                    <a href="/checkout" class="btn btn-outline-info">Passer à la caisse</a>
                    <hr>
                </div>
                @else
                    <h3>Pas d'article dans votre panier </h3>
                    <a href="/" class="btn btn-outline-dark">Voir les produits</a>
                    <hr>
                @endif
                ...
                @if ( Cart::instance('saveForLater')->count() > 0 )
                    ...
                    <div class="col-md-12">
                        ...
                        <h4>{{ Cart::instance('saveForLater')->count() }} article en attente</h4>
                        <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('moveToCart', $item->rowId) }}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-link btn-link-dark">Ajouter au panier
                                            </button>
