                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <p>{{ auth()->guard('admin')->check() ? auth()->guard()->user()->name : 'Compte' }}</p>
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="#">Profil</a></li>
                                <li><a href="{{ url('/admin/logout') }}">Deconnexion</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    ...
                    , made with <i class="fa fa-heart heart"></i> by <a href="">POD</a>
                </div>
            </div>
        </footer>
