...
Route::prefix('admin')->group(function() {
    ...
    Route::middleware('auth:admin')->group(function() {
        ...
        Route::get('users/export/', 'ExportController@index')->name('export');
        Route::get('/products/export/', 'UsersController@exportUsers');

        // PDF
        Route::get('/clients/pdf','UsersController@export_pdf');
